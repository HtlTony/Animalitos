 ...
 *
 */
public class OrejasArdilla extends Orejas {
/**
 * Se añade la clase OrejasArdilla extendido de la clase Orejas
 * Y se crean sus constructores
 */
    public OrejasArdilla() {
        super();
    }
     ...
     * @param archivo
     */
    public OrejasArdilla(String archivo) {
        super(archivo);
