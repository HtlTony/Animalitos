 ...
 *
 */
public class OrejasCocodrilo extends Orejas {
/**
 * Se añade la clase OrejasCocodrilo extendido de la clase Orejas
 * Y se crean sus constructores
 */
    public OrejasCocodrilo() {
        super();
    }
     ...
     * @param archivo
     */
    public OrejasCocodrilo(String archivo) {
        super(archivo);
