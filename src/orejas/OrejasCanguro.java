 ...
 *
 */
public class OrejasCanguro extends Orejas {
/**
 * Se añade la clase OrejasCanguro extendido de la clase Orejas
 * Y se crean sus constructores
 */
    public OrejasCanguro() {
        super();
    }
     ...
     * @param archivo
     */
    public OrejasCanguro(String archivo) {
        super(archivo);
